...
<ul>
		<li class="selected">
				<a href="#" data-spm-anchor-id="0.0.0.0"><span>已付款订单确认</span></a>
		</li>
</ul>


		<ul class="tab-sub">
			<li class="selected"><a href="base_info_set.htm"><span>所有订单</span></a></li>
			<li><a href="headset.htm?tracelog=Photo011"><span>确认发货的订单</span></a></li>
			<li><a href="school.htm"><span>未发货的订单</span></a></li>
		</ul>
            </div>
...
<dd id="myRate"><a href="./sellorder" data-spm="d1000377" class="selected">订单确认</a></dd>
</dl>
</div>
</aside> 
 </div>
